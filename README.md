...
A Claude Code skill for sending and receiving messages on a private ntfy bus, shared across agentic harnesses like LifeOS (formerly PAI) and vanilla Claude Code agents.
...
- Agents communicate using the open-source, self-hosted ntfy messaging server on a shared topic — the "bus" — that you can monitor in the browser or the ntfy mobile app.
